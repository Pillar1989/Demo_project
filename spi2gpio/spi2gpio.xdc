...
set_property PACKAGE_PIN C3 [get_ports {led[2]}]
set_property PACKAGE_PIN M4 [get_ports {led[3]}]
set_property PACKAGE_PIN C10 [get_ports {led[4]}]
set_property PACKAGE_PIN D10 [get_ports {led[5]}]
set_property PACKAGE_PIN J1 [get_ports {led[6]}]
set_property PACKAGE_PIN A13 [get_ports {led[7]}]
set_property PACKAGE_PIN M2 [get_ports {led_sel_n[0]}]
set_property PACKAGE_PIN L2 [get_ports {led_sel_n[1]}]
set_property PACKAGE_PIN L3 [get_ports rst_n]
