...
为便于统一接口，请参考 [SEA Board -Arduino FPGA Shield Software Interface Definition](https://github.com/sea-s7/Demo_project/SEA Board -Arduino FPGA Shield Software Interface Definition.md)来为Arduino主控扩展应用。
