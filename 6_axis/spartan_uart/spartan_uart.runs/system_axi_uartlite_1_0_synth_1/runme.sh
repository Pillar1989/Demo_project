...
HD_PWD='D:/zynq/spartan_uart/spartan_uart.runs/system_axi_uartlite_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_uartlite_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_uartlite_1_0.tcl
