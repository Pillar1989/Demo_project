...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../spartan_uart.srcs/sources_1/bd/system/ipshared/b65a" \
       +incdir+"$ref_dir/../../../../spartan_uart.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../spartan_uart.srcs/sources_1/bd/system/ipshared/b65a" \
       +incdir+"../../../../spartan_uart.srcs/sources_1/bd/system/ipshared/ec67/hdl"
}
